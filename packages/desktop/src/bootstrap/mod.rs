...
fn command_builder() -> Builder<tauri::Wry> {
    Builder::<tauri::Wry>::new().commands(collect_commands![
        ...
        crate::store::port_forwards::port_forward_preset_list,
        crate::store::port_forwards::port_forward_preset_create,
        crate::store::port_forwards::port_forward_preset_update,
        crate::store::port_forwards::port_forward_preset_delete,
        ...
        crate::sftp::sftp_copy_conflicts,
        crate::sftp::sftp_upload,
        crate::sftp::sftp_download,
        crate::sftp::sftp_copy,
